...
const emit = defineEmits(['switch-view', 'signup-success'])
      ...
      <div class="form-side">
        <div class="form-wrapper">
          <div class="form-header">
            <h2>Create Dispatcher Account</h2>
            <p>Access your designated fleet dashboard and begin planning routes.</p>
          </div>
          ...
          <form @submit.prevent="handleSignUp" class="signup-form">
            ...
            <div class="form-checkbox">
              <label class="checkbox-container">
                ...
                <span class="checkbox-text">
                  I agree to the Logispin Dispatch Security Terms and operational guidelines for coordinate transmission.
                </span>
              </label>
            </div>
            ...
            <button type="submit" class="btn-submit" :disabled="!isFormValid || isSubmitting">
              ...
              <span v-else>Register Dispatcher Identity</span>
            </button>
          </form>

          <div class="form-footer">
            <p>Already registered on this terminal?</p>
            <a href="#" @click.prevent="emit('switch-view')" class="login-link">Access Terminal Login</a>
          </div>
        </div>
      </div>
    </div>
